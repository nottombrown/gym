...
def upload(training_dir, algorithm_id=None, benchmark_run_id=None, writeup=None, api_key=None, ignore_open_monitors=False):
    ...
    Args:
        ...
        benchmark_run_id (Optional[str]): A benchmark_run id indicating that this evaluation is part of a larger run of the benchmark (visit https://gym.openai.com/benchmark to create an id)
